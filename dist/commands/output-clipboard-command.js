...
exports.ClipboardOutputCommand = void 0;
const base_command_1 = require("./base-command");
const ncp = require('node-clipboardy');
class ClipboardOutputCommand extends base_command_1.BaseCommand {
    execute(items) {
...
exports.ClipboardOutputCommand = ClipboardOutputCommand;
